...
***************************************************************************/
uint32_t strlen_mod(const int8_t * ptr)
{
...
***************************************************************************/
void strcpy_mod(int8_t * str1,int8_t * str2)
{
...
***************************************************************************/
int32_t strcmp_mod(const int8_t * str1, const int8_t * str2)
{
...
*                        into main string                                  *
***************************************************************************/
uint32_t strstr_mod(const int8_t *strmain, const int8_t *strsub)
{
